...
{{< hextra/hero-headline >}}
  Aprendé a desarrollar software&nbsp;<br class="hx:sm:block hx:hidden" />Desde los fundamentos a la práctica real
{{< /hextra/hero-headline >}}
</div>

<div class="hx:mb-8">
{{< hextra/hero-subtitle >}}
  Guías prácticas, tutoriales sin vueltas y proyectos reales&nbsp;<br class="hx:sm:block hx:hidden" />para que crezcas a tu ritmo y con los pies en la tierra.
{{< /hextra/hero-subtitle >}}
</div>
